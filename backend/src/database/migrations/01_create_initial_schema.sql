CREATE TABLE historial_simulaciones (
    ...
    plazo_meses INTEGER NOT NULL CHECK (plazo_meses >= 12 AND plazo_meses <= 72),
    ...
    renta_liquida NUMERIC(15,2) CHECK (renta_liquida > 0),
    antiguedad_laboral INTEGER CHECK (antiguedad_laboral >= 0),
...
CREATE TABLE solicitudes (
    ...
    monto_final_solicitado NUMERIC(15, 2) NOT NULL CHECK (monto_final_solicitado > 0),
